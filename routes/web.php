...
/*Consigue los consumos de cada dia de las ultimas 3 semanas (actual inclusive)*/
Route::get('/getEveryDayLastWeeks', 'App\Http\Controllers\MainController@getEveryDayLastWeeks');
